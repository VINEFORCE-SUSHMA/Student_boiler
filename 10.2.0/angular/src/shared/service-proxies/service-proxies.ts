...
export class StudentServiceServiceProxy {
    ...
    getAllStudents(): Observable<StudentDto[]> {
        let url_ = this.baseUrl + "/api/services/app/StudentService/GetAllStudents";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return OK
     */
    getStudentById(id: number | undefined): Observable<StudentDto> {
    ...
    protected processGetStudentById(response: HttpResponseBase): Observable<StudentDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
     ...
     * @return OK
     */
    createStudent(body: CreateStudentDto | undefined): Observable<StudentDto> {
        let url_ = this.baseUrl + "/api/services/app/StudentService/CreateStudent";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return OK
     */
    updateStudent(body: UpdateStudentDto | undefined): Observable<StudentDto> {
        let url_ = this.baseUrl + "/api/services/app/StudentService/UpdateStudent";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return OK
     */
    deleteStudent(id: number | undefined): Observable<boolean> {
        let url_ = this.baseUrl + "/api/services/app/StudentService/DeleteStudent?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
    ...
    protected processDeleteStudent(response: HttpResponseBase): Observable<boolean> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
